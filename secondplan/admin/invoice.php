...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .print-actions button, .print-actions a { padding: 10px 24px; background: linear-gradient(135deg, #DC2626, #B91C1C); border: none; border-radius: 8px; color: white; font-size: 14px; cursor: pointer; margin: 0 8px; text-decoration: none; display: inline-block; }
...
<body>
    <div class="print-actions">
        ...
        <a href="bookings.php" class="btn-back"><i class="bi bi-arrow-left"></i> Back</a>
    </div>
        ...
        <div class="invoice-body">
            <div class="invoice-parties">
                <div class="invoice-party">
                    <h3>Bill To</h3>
                    <p>
                        <strong><?= e($booking['client_name'] ?? $booking['company_name'] ?? 'Guest') ?></strong><br>
            ...
            <div class="payment-info <?= $booking['payment_status'] === 'paid' ? 'paid' : 'unpaid' ?>">
                <div>
                    <div class="status-label"><?= $booking['payment_status'] === 'paid' ? 'PAID' : 'UNPAID' ?></div>
                    <?php if ($booking['payment_status'] === 'paid' && $booking['paid_at']): ?>
                        <div class="due-date">Paid on: <?= formatDate($booking['paid_at']) ?></div>
                    <?php endif; ?>
                </div>
                <?php if ($booking['payment_due_date']): ?>
