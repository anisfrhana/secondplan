...
require_once __DIR__ . '/../config/config.php'; // loads session.php, functions.php
initSession(); // start session immediately
...
// Redirect only if FULLY logged in
if (
    isLoggedIn() &&
    !empty(getUserRole())
) {
    switch (getUserRole()) {
        ...
        default:
            destroySession(); // safety fallback
            break;
    }
}
