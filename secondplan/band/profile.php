            ...
            <div class="grid-2">
                <div class="section">
                    ...
                    <form method="POST" style="margin-top:16px;">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" value="<?= e($user['email']) ?>" disabled style="opacity:0.6">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="<?= formatDate($user['created_at']) ?>" disabled style="opacity:0.6">
                        </div>

                        <button type="submit" class="btn-primary" style="margin-top:8px;"><i class="bi bi-floppy btn-icon"></i> Update Profile</button>
                    </form>
                </div>
                ...
                <div class="section">
                    ...
                    <form method="POST" style="margin-top:16px;">
                        ...
                        <button type="submit" class="btn-primary" style="margin-top:8px;"><i class="bi bi-key btn-icon"></i> Change Password</button>
                    </form>
                </div>
            </div>
        </main>
