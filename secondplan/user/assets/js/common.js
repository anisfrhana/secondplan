var icons = {
    ...
    cart: '<i class="bi bi-cart3 btn-icon"></i>',
    save: '<i class="bi bi-floppy btn-icon"></i>',
    upload: '<i class="bi bi-upload btn-icon"></i>',
    calendar: '<i class="bi bi-calendar btn-icon"></i>',
    tag: '<i class="bi bi-tag btn-icon"></i>',
    user: '<i class="bi bi-person-circle btn-icon"></i>',
    home: '<i class="bi bi-house-door btn-icon"></i>',
    clipboard: '<i class="bi bi-clipboard-check btn-icon"></i>'
};
